...
export const TraceWriteSource: core.serialization.Schema<serializers.TraceWriteSource.Raw, OpikApi.TraceWriteSource> =
    core.serialization.enum_(["sdk", "experiment", "playground", "optimization", "evaluator"]);

export declare namespace TraceWriteSource {

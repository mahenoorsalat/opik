...
You can hand-write the JSON, but the product will build it for you, including any [cost policies](/cost-intelligence/reduce-agent-spend#step-3-apply-it-as-policy) you've already configured.

...
export const guardrailsMap: Record<QuickConfigGuardrailType, GuardrailConfig> =
  {
...
export const guardrailsDefaultState: GuardrailsState = (
  Object.keys(guardrailsMap) as QuickConfigGuardrailType[]

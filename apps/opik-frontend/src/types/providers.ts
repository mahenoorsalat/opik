...
export enum PROVIDER_MODEL_TYPE {
  ...
  ANTHROPIC_CLAUDE_SONNET_4_5_BATCH = "anthropic/claude-sonnet-4.5:batch",
  ...
  GOOGLE_GEMINI_2_5_FLASH_LITE_BATCH = "google/gemini-2.5-flash-lite:batch",
  GOOGLE_GEMINI_2_5_FLASH_PREVIEW_09_2025 = "google/gemini-2.5-flash-preview-09-2025",
  GOOGLE_GEMINI_2_5_FLASH_BATCH = "google/gemini-2.5-flash:batch",
  ...
  GOOGLE_GEMINI_2_5_PRO_BATCH = "google/gemini-2.5-pro:batch",
  GOOGLE_GEMINI_3_FLASH_PREVIEW = "google/gemini-3-flash-preview",
  GOOGLE_GEMINI_3_FLASH_PREVIEW_BATCH = "google/gemini-3-flash-preview:batch",
  ...
  GOOGLE_GEMINI_3_1_FLASH_LITE_BATCH = "google/gemini-3.1-flash-lite:batch",
  ...
  GOOGLE_GEMINI_3_1_PRO_PREVIEW_BATCH = "google/gemini-3.1-pro-preview:batch",
  GOOGLE_GEMINI_3_5_FLASH = "google/gemini-3.5-flash",
  GOOGLE_GEMINI_3_5_FLASH_LITE = "google/gemini-3.5-flash-lite",
  GOOGLE_GEMINI_3_5_FLASH_LITE_BATCH = "google/gemini-3.5-flash-lite:batch",
  ...
  OPENAI_GPT_5_MINI_BATCH = "openai/gpt-5-mini:batch",
  OPENAI_GPT_5_NANO = "openai/gpt-5-nano",
  OPENAI_GPT_5_NANO_BATCH = "openai/gpt-5-nano:batch",
  ...
  OPENAI_GPT_5_1_BATCH = "openai/gpt-5.1:batch",
  ...
  OPENAI_GPT_5_2_BATCH = "openai/gpt-5.2:batch",
  ...
  OPENAI_GPT_5_4_MINI_BATCH = "openai/gpt-5.4-mini:batch",
  OPENAI_GPT_5_4_NANO = "openai/gpt-5.4-nano",
  OPENAI_GPT_5_4_NANO_BATCH = "openai/gpt-5.4-nano:batch",
  OPENAI_GPT_5_4_PRO = "openai/gpt-5.4-pro",
  OPENAI_GPT_5_4_BATCH = "openai/gpt-5.4:batch",
  OPENAI_GPT_5_5 = "openai/gpt-5.5",
  OPENAI_GPT_5_5_PRO = "openai/gpt-5.5-pro",
  OPENAI_GPT_5_5_BATCH = "openai/gpt-5.5:batch",
